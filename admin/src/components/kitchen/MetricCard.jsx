...
export default function MetricCard({ title, value, prefix = '', suffix = '', decimals = 0, icon: Icon, trend = '', trendUp = true, index = 0, progress = null, miniChart = null }) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: `radial-gradient(600px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), ${gradient.glow}, transparent 40%)`,
        }}
      />
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 4px 16px ${gradient.glow}`,
            }}
          >
        ...
        {progress !== null && (
          <div className="mt-3">
            <div className="flex items-center justify-between text-xs mb-1">
              ...
              <span style={{ color: gradient.from }}>{progress}%</span>
            </div>
