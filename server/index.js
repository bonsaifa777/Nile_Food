...
import nileInventoryRoutes from './routes/nileInventory.js';
import nileEmployeesRoutes from './routes/nileEmployees.js';
...
app.use('/api/nile-inventory', nileInventoryRoutes);
app.use('/api/nile-employees', nileEmployeesRoutes);
...
httpServer.listen(PORT, '0.0.0.0', () => {
  ...
  if (isOffline) {
    ...
    console.log('  Cashier:     cashier@foodapp.com / Admin@123');
    console.log('  Waiter:      waiter@foodapp.com / Admin@123');
    console.log('========================================\n');
  }
});
