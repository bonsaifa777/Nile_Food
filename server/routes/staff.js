...
const STAFF_MANAGER_ROLES = [ROLES.ADMIN, ROLES.SUPER_ADMIN, ROLES.KITCHEN_STAFF, ROLES.CASHIER, ROLES.WAITER];
const STAFF_DELIVERY_ROLES = [ROLES.ADMIN, ROLES.SUPER_ADMIN, ROLES.DELIVERY_DRIVER, ROLES.CASHIER, ROLES.WAITER];
